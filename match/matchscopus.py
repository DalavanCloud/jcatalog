                ...
                if flag == 0:
                    ...
                    if len(query_issn_scielo) > 1 and flag == 0:
                        ...
                        if len(query_issn_title_scielo) == 1:
                            ...
                            msg = 'ISSN and title Scopus: %s : %s is Scielo' % (issn, doc.title)
                            logger.info(msg)
                            print(msg)
                ...
                if flag == 0:
                    ...
                    if len(query_issn_wos) > 1 and flag == 0:
                        ...
                        if len(query_issn_title_wos) == 1:
                            ...
                            msg = 'ISSN and title Scopus: %s : %s is Wos' % (issn, doc.title)
                            logger.info(msg)
                            print(msg)
                ...
                if flag == 0:
                    ...
                    if len(query_issn_scimago) > 1 and flag == 0:
                        ...
                        if len(query_issn_title_scimago) == 1:
                            ...
                            msg = 'ISSN and title Scopus: %s : %s is Scimago' % (issn, doc.title)
                            logger.info(msg)
                            print(msg)
