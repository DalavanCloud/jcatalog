    ...
    for doc in scielo:
        ...
        if 'scieloci' in doc:
            ...
            if 'scieloci_cited_2015' in doc['scieloci']:
                worksheet.write(row, col, doc['scieloci']['scieloci_cited_2015'])
            col += 1
            if 'scieloci_wos_cited_2015' in doc['scieloci']:
                worksheet.write(row, col, doc['scieloci']['scieloci_wos_cited_2015'])
            col += 1
        else:
            col += 3
        ...
        if 'times' in doc:
            ...
            if 'media_meses_aprov_pub_scielo_2017' in doc['times']:
                times = timesfmt(doc['times']['media_meses_aprov_pub_scielo_2017'])
                worksheet.write(row, col, times)
            col += 1
        else:
            col += 2
