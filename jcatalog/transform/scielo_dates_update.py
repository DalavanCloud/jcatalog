...
logging.basicConfig(
    filename='logs/dates_update.info.txt', level=logging.INFO)
...
def creationdate(filename):
    ...
    for rec in sheet_json:
        ...
        if query:
            ...
            data = {}
            data['journal_creation_year'] = rec['journal_creation_year']
...
def main():
    ...
    creationdate('data/scielo/check_dates_scielo.xlsx')
