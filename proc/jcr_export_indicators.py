...
logging.basicConfig(filename='logs/jcr_export_indicators.info.txt',level=logging.INFO)
logger = logging.getLogger(__name__)


#CSV header
header = [
'issn_scielo_collection',
'year',
'issn_scielo',
'collection',
'title_scielo',
...
with open('scielo_jcr_indicators.csv', 'w') as csv_utf:
    ...
    for doc in scielodocs:
        ...
        if doc.is_wos == 1:
            ...
            issn_scielo_collection = '%s-%s' % (doc.issn_scielo, doc.collection)
